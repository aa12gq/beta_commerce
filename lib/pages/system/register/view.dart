import 'package:beta_commerce/common/components/page_title.dart';
import 'package:beta_commerce/common/index.dart';
import 'package:beta_commerce/common/utils/validators.dart';
...
class RegisterPage extends GetView<RegisterController> {
  ...
  Widget _buildForm() {
    return Form(
      key: controller.formKey, // globalKey，用于后面获取FormState
